...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url ${SEPOLIA_RPC_URL} --private-key ${PRIVATE_KEY} --broadcast --verify --verifier-url ${SEPOLIA_API_URL} --etherscan-api-key ${ETHERSCAN_API_KEY} -vvvv
